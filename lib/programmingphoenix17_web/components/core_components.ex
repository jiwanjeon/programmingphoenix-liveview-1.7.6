defmodule Programmingphoenix17Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Programmingphoenix17Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Programmingphoenix17Web.Gettext, "errors", msg, opts)
    end
  end
